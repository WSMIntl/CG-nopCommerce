...
public class GoogleAnalyticsPlugin : BasePlugin, IWidgetPlugin
{
    ...
    public override async Task InstallAsync()
    {
        var settings = new GoogleAnalyticsSettings
        {
            ...
            SuppressLegacyUniversalAnalytics = true,
        ...
        await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
        {
            ...
            ["Plugins.Widgets.GoogleAnalytics.EnableEcommerce.Hint"] = "Check to pass information about orders to Google eCommerce feature.",
             ...
             ["Plugins.Widgets.GoogleAnalytics.SuppressLegacyUniversalAnalytics"] = "Suppress legacy Universal Analytics",
             ["Plugins.Widgets.GoogleAnalytics.SuppressLegacyUniversalAnalytics.Hint"] = "When enabled, suppresses UA-49725360-1 while preserving the saved tracking script so it can be restored later.",
